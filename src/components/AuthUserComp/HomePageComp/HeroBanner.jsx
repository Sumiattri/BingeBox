...
const HeroBanner = () => {
  ...
  return (
    ...
    h-[56vh] sm:h-[80vh] md:h-[90vh] lg:h-[88vh] md:mt-0 mt-37  md:mx-0 mx-6 md:rounded-none rounded-xl  flex items-center justify-center px-4`}
      ...
      >
        {/* Overlay Gradient */}
        <div className="absolute block   inset-0 bg-gradient-to-r sm:from-black/80 from-black/40 sm:via-black/40 via-black/30 to-transparent md:rounded-none rounded-xl "></div>
