    ...
    <div className="w-full h-auto flex flex-col lg:px-35 md:px-20 px-5 bg-black pt-5 ">
      ...
      <div className="flex flex-col gap-2 pt-4 px-4">
        <div className="flex flex-col px-4 bg-[#2d2d2d] hover:bg-[#3b3b3f] ">
          <details className="group border-b border-gray-700 py-4 cursor-pointer ">
            ...
            <div className="mt-3 lg:text-2xl text-md lg:font-semibold text-gray-300 lg:leading-relaxed pr-4">
              BingeBox is a streaming service that offers a wide variety of
        ...
        <div className="flex flex-col px-4 bg-[#2d2d2d] hover:bg-[#3b3b3f]">
          <details className="group border-b border-gray-700 py-4 cursor-pointer">
            <summary className="text-white h-10 lg:text-2xl text-xl lg:font-semibold  flex justify-between items-center">
              <span>How mmuch does BingeBox cost?</span>
              <span className="lg:text-5xl text-4xl transition-transform duration-300 group-open:rotate-45">
                +
              </span>
            </summary>
            <hr className="text-gray-400 mt-3 " />
            <div className="mt-3 lg:text-2xl text-md lg:font-semibold text-gray-300 lg:leading-relaxed pr-4">
              Watch BingeBox on your smartphone, tablet, Smart TV, laptop, or
        ...
        <div className="flex flex-col px-4 bg-[#2d2d2d] hover:bg-[#3b3b3f]">
          <details className="group border-b border-gray-700 py-4 cursor-pointer">
            ...
            <hr className="text-gray-400 mt-3 " />
            <div className="mt-3 lg:text-2xl text-md lg:font-semibold text-gray-300 lg:leading-relaxed pr-4">
              Watch anywhere, anytime. Sign in with your BingeBox account to
              watch instantly on the web at BingeBox.com from your personal
              computer or on any internet-connected device that offers the
              BingeBox app, including smart TVs, smartphones, tablets, streaming
              ...
              Take BingeBox with you anywhere.
            </div>
          </details>
        </div>
        <div className="flex flex-col px-4 bg-[#2d2d2d] hover:bg-[#3b3b3f]">
          <details className="group border-b border-gray-700 py-4 cursor-pointer">
            ...
            <hr className="text-gray-400 mt-3 " />
            <div className="mt-3 lg:text-2xl text-md lg:font-semibold text-gray-300 lg:leading-relaxed pr-4">
              BingeBox commitments. You can easily cancel your account online in
        ...
        <div className="flex flex-col px-4 bg-[#2d2d2d] hover:bg-[#3b3b3f] ">
          <details className="group border-b border-gray-700 py-4 cursor-pointer">
            <summary className="text-white h-10 lg:text-2xl text-xl lg:font-semibold  flex justify-between items-center">
              <span>What can I watch on BingeBox?</span>
              <span className="lg:text-5xl text-4xl transition-transform duration-300 group-open:rotate-45">
                +
              </span>
            </summary>
            <hr className="text-gray-400 mt-3 " />
            <div className="mt-3 lg:text-2xl text-md lg:font-semibold text-gray-300 lg:leading-relaxed pr-4">
              BingeBox has an extensive library of feature films, documentaries,
              TV shows, anime, award-winning BingeBox originals, and more. Watch
        ...
        <div className="flex flex-col px-4 bg-[#2d2d2d] hover:bg-[#3b3b3f]">
          <details className="group border-b border-gray-700 py-4 cursor-pointer">
            <summary className="text-white h-10 lg:text-2xl text-xl lg:font-semibold  flex justify-between items-center">
              <span>Is BingeBox good for kids?</span>
              <span className="lg:text-5xl text-4xl transition-transform duration-300 group-open:rotate-45">
                +
              </span>
            </summary>
            <hr className="text-gray-400 mt-3 " />
            <div className="mt-3 lg:text-2xl text-md lg:font-semibold text-gray-300 lg:leading-relaxed pr-4">
              The BingeBox Kids experience is included in your membership to
