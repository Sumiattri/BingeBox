...
function JoinReasons() {
  return (
    <div className="w-full h-auto flex flex-col lg:px-35 md:px-20 px-5 bg-black">
      <div className="bg-black px-6">
        <h2 className="text-white lg:text-2xl sm:text-xl text-lg font-semibold  sm:-ml-4 -ml-2">
          More Reasons to Join
        </h2>
      </div>
      <div className="grid lg:grid-cols-4  grid-cols-1 lg:gap-6 gap-2 py-7 px-4">
        <div className="relative  rounded-2xl bg-gradient-to-br from-[#192144] to-[#220f18] flex flex-col pt-6 px-6 pb-20 lg:pb-32 gap-3 ">
        ...
        <div className="relative  rounded-2xl bg-gradient-to-br from-[#192144] to-[#220f18] flex flex-col pt-6 px-6 pb-20 gap-3 ">
          <h2 className="text-2xl text-white font-semibold">
            Download your shows to watch offline
          </h2>{" "}
          <p className="text-md text-gray-400">
            Save your favouri tes easily and always have something to watch.
          </p>
          <div className="absolute bottom-10 right-10 h-10 w-10">
            {" "}
            <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
        ...
        <div className="relative  rounded-2xl bg-gradient-to-br from-[#192144] to-[#220f18] flex flex-col pt-6 px-6 gap-3 pb-20 ">
          <h2 className="text-2xl text-white font-semibold">
