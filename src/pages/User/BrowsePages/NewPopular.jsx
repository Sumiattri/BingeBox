...
import NewPopularBanner from "../../../components/AuthUserComp/HomePageComp/NewPopularBanner";
import { baseImgUrl } from "../../../utils/constants";
import Modal from "./Modal";

function NewPopular() {
  const thriller = useSelector((state) => state.movie.scifi);
  const movies = useSelector((state) => state.movie.kDrama);
  const romance = useSelector((state) => state.movie.tvDrama);
